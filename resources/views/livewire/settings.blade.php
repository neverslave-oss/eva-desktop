<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="bg-gray-900 rounded-xl border border-gray-800 p-6">
        ...
        <div class="space-y-4">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-300 mb-1">Pair Token</label>
                <input type="text" wire:model="pairToken"
                    placeholder="40-character pair token"
                    class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm font-mono">
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-300 mb-1">Pair Secret</label>
                <input type="password" wire:model="pairSecret"
                    placeholder="40-character pair secret"
                    class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm font-mono">
                <p class="text-xs text-gray-500 mt-1">
                    Generate these at kernel-central → <strong class="text-gray-400">Pair a Device</strong> → select type <strong class="text-gray-400">Desktop</strong> → copy Token &amp; Secret from the Manual Pairing section.
                </p>
            </div>
