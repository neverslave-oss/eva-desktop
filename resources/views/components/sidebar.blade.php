<nav class="w-auto sm:w-64 bg-gray-900 border-r border-gray-800 flex flex-col shrink-0">
    <!-- Logo -->
    <div class="p-4 border-b border-gray-800">
        {{-- Logo and App Name --}}
        <a href="{{ route('dashboard') }}" class="flex items-center gap-3">
            <img src="{{ asset('icon.png') }}" alt="EvAgent Logo" class="w-8 h-8">
            <span class="hidden sm:inline text-lg font-semibold text-gray-100">{{ config('app.name', 'EvAgent Desktop') }}</span>
        </a>
    </div>
    ...
    <div class="p-4 border-t border-gray-800">
        <a href="{{ route('setup-wizard') }}"
           ...
           wire:navigate>
            ...
            <span class="hidden sm:inline">Setup Wizard</span>
        </a>
    </div>
</nav>
