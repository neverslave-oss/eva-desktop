<nav class="w-64 bg-gray-900 border-r border-gray-800 flex flex-col shrink-0">
    ...
    <div class="flex-1 p-4 space-y-1 overflow-y-auto">
        @php
            $tabs = [
                ...
                ['route' => 'routines',    'label' => 'Routines',    'icon' => 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z'],
                ...
                ['route' => 'workspace',   'label' => 'Workspace',   'icon' => 'M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z'],
                ['route' => 'sqlite',       'label' => 'SQLite',       'icon' => 'M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4'],
    ...
    <div class="p-4 border-t border-gray-800">
        <a href="{{ route('setup-wizard') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium bg-indigo-600/20 text-indigo-400 hover:bg-indigo-600/30 transition-colors"
           wire:navigate>
