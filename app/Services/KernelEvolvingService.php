...
class KernelEvolvingService
{
     ...
     */
    public function startDocker(?string $repoDir = null): array
    {
        ...
        if (!File::exists($envPath)) {
            $this->writeDockerEnvFile($envPath);
        }
     ...
     */
    protected function writeDockerEnvFile(string $path): void
    {
        $lines = [
            ...
            'KERNEL_USER_NAME=KernelUser',
            'KERNEL_USER_HANDLE=kerneluser',
            'OPENAI_API_KEY=',
            'ANTHROPIC_API_KEY=',
            'GITHUB_TOKEN=',
            'HF_TOKEN=',
